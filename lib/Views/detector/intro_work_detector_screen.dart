...
import 'package:grade_project/Views/detector/detector_screen.dart';
...
class IntroDetectorScreen extends StatefulWidget {
  ...
  final VoidCallback updateData; // مرجع لدالة التحديث

  const IntroDetectorScreen({
    super.key,
    required this.name,
    required this.routeNumber,
    required this.plateNumber,
    required this.updateData, // استقبال مرجع التحديث
  });
      ...
      child: Column(
        ...
        children: [
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.center,
                    children: [
                      const Text("مفتش :", style: TextStyle(color: Colors.white),),
          ...
          MaterialButton(
            ...
            color: Colors.blue,
            onPressed: () async {
              navigateTo(context, const DetectorScreen());
            },
